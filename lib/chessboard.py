...
class _ChessBoardPieces(_ChessBoardCore):
    ...
    def _allowedmoves(self, piece):
        """Finds the allowed moves for 'piece'.
        ...
        # TODO: FIXME: This method is a clusterfuck.
        ...
        for move in movelist:
            ...
            if self._board[moveindex] != None:  # Check for occupied squares.
                ...
                if piece.piecetype() is not KnightPiece:
                    continue
            else:
    ...
    def allpossiblemoves(self):
        """Gets all of the possible moves available for each piece. WIP."""
        allpossiblemoves = dict()
        for square in self._board:
            if square is None:  # Continue loop if square is empty.
                continue
            movelist = self._allowedmoves(square)  # Basic allowed moves.
            allpossiblemoveslist[square] = movelist  # Add them to possible moves.
